...
for year in availableYears:
        ...
        if __name__ == "__main__":
          ...
          if __name__ == '__main__':
            ...
            template_url = 'https://gis.hennepin.us/arcgis/services/Imagery/UTM_Aerial_'+year+'/MapServer/WMSServer?version=1.3.0&&service=WMS&request=GetMap&&styles=&layers=0&CRS=EPSG:26915&BBOX={:},{:},{:},{:}&width=302&height=302&format=image/tiff'
